...
{/* TASTO PASSWORD DIMENTICATA (FIX UNIVERSALE WEB/APP) */}
            ...
            {!isLogin && (
              <>
                ...
                <TextInput style={styles.input} placeholder="Es.Massimo" placeholderTextColor="#64748b" value={firstName} onChangeText={setFirstName}/>
                <Text style={styles.label}>Cognome</Text>
                <TextInput style={styles.input} placeholder="Es.Guglielmi" placeholderTextColor="#64748b" value={lastName} onChangeText={setLastName}/>
